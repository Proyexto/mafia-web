        ...
        <ul className="flex justify-around gap-4">
          ...
          </li>
          {
            sessionStatus ? 
              (
                <li className="flex md:order-2">
                    <button className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-600 font-medium rounded-lg text-xl p-2 text-center mr-3 md:mr-0" aria-label="cerrar sesión" onClick={handleClose}>
